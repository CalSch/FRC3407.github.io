...
export default function Home() {
  return (
    <div>
      ...
      <p>The next competition will be <a href="https://firebears.org/2022-minnesota-robotics-invitational/">Minnesota Robotics Invitational</a> on October 15th, 2022 at Roseville High School.</p>
      <p><br />Come back soon to see the new and improved website!</p>
